...
import { Heart, Building2, Phone, Facebook, Info, Globe, FileCheck, Mail, CreditCard } from 'lucide-react';
import unitedLogo from '@/assets/united17-logo.jpg';
import { EmotionalAppeal } from './EmotionalAppeal';
import { ActiveWorkNotice } from './ActiveWorkNotice';
        ...
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="mt-8 rounded-lg border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-blue-500/10 p-6">
            ...
            <p className="mb-6 text-sm text-muted-foreground">
              ...
              you can donate directly through our European bank account.
            </p>
